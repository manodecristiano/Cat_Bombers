...
class TestRapidoTema extends StatefulWidget {
  final int totaldePreguntas;
  final String tema;
  const TestRapidoTema(this.totaldePreguntas, this.tema, {super.key});

  @override
  State<TestRapidoTema> createState() => _TestRapidoTema();
}

class _TestRapidoTema extends State<TestRapidoTema> {
  int totalOptions = 4;
  int questionIndex = 0;
  int progressBar = 1;
